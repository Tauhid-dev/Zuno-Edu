...
for o in b['operations']:
 s+='## '+o['id']+'\n\n'
 for label,x in [('Method/route',o['method']+' '+o['route']),('Purpose',o['purpose']),('Roles',o['roles']),('Ownership / assignment / state',o['ownership']),('Request',o['request']),('Response',o['response']),('Application operation',o['service']),('Domain objects',o['objects']),('Repository / ports',o['ports']),('Errors',o['errors']),('Requirements',o['requirements']),('Consumers',o['consumer'])]:s+=f'- **{label}:** {val(x)}\n'
 s+='\n'
put('API_CATALOG',s)
